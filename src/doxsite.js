...
export class Doxsite
{
	 ...
	 * @param {String} [config.outputPath='develop'] - Path to the local root of the documentation site where pages will be created.
	 ...
	 * @param {String} [config.apiSubPath='API'] - Path relative from `outputPath`/`urlRootPath` where documentation pages will be created/located.
	 * @param {String} [config.searchdataSubPath='scripts'] - Path relative from `outputPath`/`urlRootPath` where the search data file (searchdata.js) will be created/located.
	 */
	...
	static buildDocs(config)
	{
		...
		docBuilder.outputPath = config.outputPath || 'develop';
