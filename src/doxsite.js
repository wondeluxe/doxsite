...
export class Doxsite
{
	 ...
	 * @param {String} buildConfig.xmlPath - Path to XML generated by Doxygen. Output location is defined by the `OUTPUT_DIRECTORY` and `XML` options in the Doxyfile.
	 ...
	 * @param {DocBuilderTemplates} buildConfig.templates - Templates used to generate documentation files.
	 * @param {String} buildConfig.outputPath - Path the documentation files are written to.
	...
	/**
	 * Run Doxygen on the command line using a given Doxyfile.
	 * @param {String} doxyfile - Path to the Doxyfile.
	 */
	 ...
	 * @param {String} config.xmlPath - Path to XML generated by Doxygen. Output location is defined by the `OUTPUT_DIRECTORY` and `XML` options in the Doxyfile.
	 ...
	 * @param {DocBuilderTemplates} config.templates - Templates used to generate documentation files.
	 * @param {String} config.outputPath - Path the documentation files are written to.
	...
	static buildDocs(config)
	{
		...
		docBuilder.templates = config.templates;
